...
export function initGachonMap(scene, world) {
	...
	// C (고스트 시작 위치)
	Utils.createWallObject(scene, world, 'wall1', 0xFFFFFF, 100, 800, 700);
	...
	Utils.object['wall2'].position(-300, 0, 0);
	Utils.createWallObject(scene, world, 'wall3', 0xFFFFFF, 100, 800, 700);
	...
	Utils.object['ghost_wall'].position(300, 0, 0);
	...
	Utils.createWallObject(scene, world, 'wall6', 0x1200ff, 100, 800, 700);
	...
	Utils.createWallObject(scene, world, 'wall9', 0x1200ff, 100, 800, 700);
	...
	Utils.createWallObject(scene, world, 'wall20', 0x1200ff, 200, 800, 1000);
	Utils.object['wall20'].position(-1500, 0, 0);
	Utils.object['wall20'].rotateY(90);
	Utils.createWallObject(scene, world, 'wall21', 0x1200ff, 200, 800, 1000);
	...
	// G
	Utils.createWallObject(scene, world, 'wall27', 0x004e96, 1800, 800, 200);
	Utils.object['wall27'].position(-4200, 0, -2500);
	...
	Utils.object['wall29'].position(-3400, 0, -1700);
	Utils.createWallObject(scene, world, 'wall30', 0x004e96, 900, 800, 200);
	Utils.object['wall30'].position(-2800, 0, -2100);
	Utils.object['wall30'].rotateY(90);
	Utils.createWallObject(scene, world, 'wall31', 0x004e96, 900, 800, 200);
	Utils.object['wall31'].position(-3200, 0, -2500);

	// A
	Utils.createWallObject(scene, world, 'wall32', 0x004e96, 1800, 800, 200);
	Utils.object['wall32'].position(-4200, 0, 2500);
	Utils.object['wall32'].rotateY(90);
	Utils.createWallObject(scene, world, 'wall33', 0x004e96, 1800, 800, 200);
	Utils.object['wall33'].position(-2900, 0, 2500);
	Utils.object['wall33'].rotateY(90);
	Utils.createWallObject(scene, world, 'wall34', 0x004e96, 1400, 800, 200);
	Utils.object['wall34'].position(-3500, 0, 1700);
	Utils.createWallObject(scene, world, 'wall35', 0x004e96, 1400, 800, 200);
	Utils.object['wall35'].position(-3500, 0, 2600);

	// H
	Utils.createWallObject(scene, world, 'wall36', 0xfcaf16, 1400, 800, 200);
	Utils.object['wall36'].position(3400, 0, -1700);
	Utils.createWallObject(scene, world, 'wall37', 0xfcaf16, 1600, 800, 200);
